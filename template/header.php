    ...
    <div class="offcanvas offcanvas-end d-xxl-none d-xl-none" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="background-image: var(--fondo-menu);">
        ...
        <div class="offcanvas-body d-block d-lg-none text-start">
            <ul class="container col-sm-12 navbar-nav me-auto ps-3">
                ...
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="ourApproach.php#ourApproach">OUR APPROACH</a></button>
                </li>
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="ourTeam.php#team">OUR TEAM</a></button>
                </li>
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="compliance.php">COMPLIANCE</a></button>
                </li>
                <li class="pt-4 pe-4">
