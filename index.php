                    ...
                    <div class="row">
                        <div class="col-sm-12 align-self-center">
                            <div class="mb-3 mt-3">
                                ...
                                <div class="col-sm-12 col-md-12 mt-3 d-flex justify-content-center text-center mb-5">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 pb-md-4 align-self-start text-center text-md-start">
                        <h2 class="titleSection" style="color: var(--link) !important;">Who we are</h2>
                    </div>
                    <div class="col-md-6 mb-md-4 align-self-end text-center text-md-start">
                        <p class="text1 animate__animated animate__backInRight animate__delay-0s animate__fast text-md-start" style="color: var(--link) !important;">
                            LXG Family Office is a company dedicated to providing
                            wealth management and family office services to our clients
                            throughout Latin America and the U.S.
                            <br><br>
                            Our team of highly qualified professionals provides
                            fiduciary services and independent advice,
